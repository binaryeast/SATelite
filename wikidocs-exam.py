...
class MyWindow(QWidget):
    ...
    def setupUI(self):
        ...
        coreBox = QVBoxLayout()
        coreBox.addWidget(checkBox1)
        coreBox.addWidget(checkBox2)
        coreBox.addWidget(checkBox3)
        coreBox.addWidget(checkBox4)
        coreBox.addWidget(checkBox5)
        coreBox.addWidget(checkBox6)
        coreBox.addWidget(checkBox7)
        coreBox.addWidget(checkBox8)
        coreBox.addWidget(checkBox9)
        
        groupBox.setLayout(coreBox)
